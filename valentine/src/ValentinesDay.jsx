...
const images = [
  ...
  { src: img4, text: "Nunca me ha gustado tomarme fotos, pero contigo me tomaría 150 fotos en un día si es que quieres, porque yo lo quiero hacer todos los días de mi vida, porque así un día podremos sonreír viendo las fotos que nos tomamos, desde las más lindas hasta las más randoms"  },
  { src: img5, text: "¿Sabías que los ojos no mienten? y mis ojos nunca mienten cuando te ven, porque puedo asegurarte que de lejos se nota el amor que te tengo, y si de algo no tengo duda, es que te veré de la misma manera para siempre." },
  ...
  { src: img9, text: "Tu, mi princesa, el amor de mi vida, amo tu sonrisa y tu mirada, esta foto fue tan improvisada que salió tan linda, definitivamente una de mis fotos favoritas junto a ti, siempre que la veo viene a mi mente lo feliz que soy cuando estoy junto a ti y como es que no paro de contar los días para verte de nuevo." },
